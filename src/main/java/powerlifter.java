public class powerlifter implements user2 {
    String doesCompete;
    int maxDeadlift;
    int maxSquat;
    int maxBench;
    ...
    public void setThousandPoundClub(String thousandPoundClub) {
    ...
    public String getThousandPoundClub() {
        return thousandPoundClub;
    }
