...
//Maher
    ...
    public class testModify(){
        ...
        public void testModify(){
           user user1 = new user("first","last","11111111","user@gmail.com",
                   "male",2000,01,01);
           modifyProfile(user1);
            assertEquals("11111111", user1.phoneNumber,"Phone number not changed");
        }
    }
    ...
    public class displayUserTest(){
        ...
        public void displayTest(){
            user user1 = new user("first","last","11111111","user@gmail.com",
                    "male",2000,01,01);
            displayUser(user1);
            assertEquals("last", user1.lastName,"User displayed");
        }
    }
    ...
    public class setFirstNameTest(){
        ...
        public void setFirstNameTest(){
            ...
            assertEquals("firstName", user1.firstName,"First name set");
        }
    }
    ...
    public class setLastNameTest(){
        ...
        public void setLasttNameTest(){
            ...
            assertEquals("lastName", user1.lastName,"Last name set");
        }
    }
    ...
    public class setNumberTest(){
        ...
        public void setNumberTest(){
            ...
            assertEquals("111111111", user1.phoneNumber,"Phone number set");
        }
    }
}
